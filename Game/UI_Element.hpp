...
public:
    ...
    Button(std::string data="", SHORT X=0, SHORT Y=0, SHORT W=1, SHORT H=1, Color::Foreground Bord_FC=Color::Foreground::Black,
           Color::Foreground FC=Color::Foreground::Black, Color::Background Bord_BC=Color::Background::Black, Color::Background BC=Color::Background::Black) :
...
public:
    ...
    Static_Button(std::string data="", SHORT X=0, SHORT Y=0, SHORT W=1, SHORT H=1, Color::Foreground Bord_FC=Color::Foreground::Black,
           Color::Foreground FC=Color::Foreground::Black, Color::Background Bord_BC=Color::Background::Black, Color::Background BC=Color::Background::Black) :
    BUTTON_TYPE(data,X,Y,W,H,Bord_FC,FC,Bord_BC,BC)
...
public:
    ...
    Radio_Button(SHORT X=0, SHORT Y=0, Color::Foreground Bord_FC=Color::Foreground::Black, Color::Foreground FC=Color::Foreground::Black,
                 Color::Background Bord_BC=Color::Background::Black, Color::Background BC=Color::Background::Black) :
...
public:
    ...
    Image_Button(std::string data="", std::string path="", SHORT X=0, SHORT Y=0, SHORT W=1, SHORT H=1, SHORT DX = 0,
                 SHORT DY = 0, SHORT TY = 0, Color::Foreground Bord_FC=Color::Foreground::Black, Color::Foreground FC=Color::Foreground::Black,
                 Color::Background Bord_BC=Color::Background::Black, Color::Background BC=Color::Background::Black) :
